...
const routes: Routes = [
  ...
  { path: 'increasing-instr', loadChildren: './quickplayOld/increasing-instr/increasing-instr.module#IncreasingInstrPageModule' },
  { path: 'increasing-test', loadChildren: './quickplayOld/increasing-test/increasing-test.module#IncreasingTestPageModule' },
  { path: 'decreasing-instr', loadChildren: './quickplayOld/decreasing-instr/decreasing-instr.module#DecreasingInstrPageModule' },
  { path: 'decreasing-test', loadChildren: './quickplayOld/decreasing-test/decreasing-test.module#DecreasingTestPageModule' },
  { path: 'results', loadChildren: './quickplayOld/results/results.module#ResultsPageModule' },
